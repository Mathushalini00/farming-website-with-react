...
export function Blog() {
  const posts = [
    {
      title: "5 Benefits of Organic Farming",
      excerpt: "Discover why organic farming is better for your health, the environment, and local communities.",
      date: "March 15, 2024",
      image: "/organic-farm-sustainable-practices.jpg",
    },
    {
